...
class UploadButton extends StatelessWidget with ThemeProvider {
  ...
  factory UploadButton.videoUploadButton({
    ...
    return UploadButton(
      ...
      selected: selected,
      label: label,
      iconPaths: const [AppAsset.GALLER_ON, AppAsset.GALLERY_OFF],
    );
  }
  ...
  factory UploadButton.youtubeUrlUploadButton({
    ...
    return UploadButton(
      ...
      selected: selected,
      label: label,
      iconPaths: const [AppAsset.YOUTUBE_ON, AppAsset.YOUTUBE_OFF],
    );
  }
